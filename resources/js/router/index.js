...
import SwiftpayTopup from '../components/SwiftpayTopup.vue'
import SwiftPayHistory from '../components/SwiftPayHistory.vue'
...
const routes = [
  ...
  },
  {
    path: '/swiftpay',
    name: 'SwiftPay',
    component: SwiftpayTopup
  },
  {
    path: '/swiftpay/history',
    name: 'SwiftPayHistory',
    component: SwiftPayHistory
  },
  {
    path: '/pusat-bantuan',
    name: 'PusatBantuan',
